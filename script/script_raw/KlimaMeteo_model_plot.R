...
for (l in 1:5){
  ...
  summary(MeteoMonth_df_tidy_summaries_diff2070_sf$Tav_Jul_Mean)
  summary(MeteoMonth_df_tidy_summaries_diff2021_sf$Tav_Jul_Mean)
  ...
  ## Define colorRamp for July Temperature 
  summary(MeteoMonth_df_tidy_summaries_diff2070_sf$Pre_Jul_Mean)
  summary(MeteoMonth_df_tidy_summaries_diff2021_sf$Pre_Jul_Mean)
